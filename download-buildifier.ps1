...
Invoke-WebRequest -Uri "https://github.com/bazelbuild/buildtools/releases/download/v7.3.1/buildifier-windows-amd64.exe" -OutFile "C:buildifier.exe"
...
Unblock-File -Path "C:buildifier.exe"